<?php include 'helper/base_url.php'; ?> 
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="assets/images/logo1-icon.png" width="55px" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="assets/images/logo-student.png" width="130px" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
